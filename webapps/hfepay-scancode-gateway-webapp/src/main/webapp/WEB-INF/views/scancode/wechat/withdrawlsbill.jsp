...
<div class="lscx_title">
	...
	<div class="lscx_screen"><a href="javascript:void(0);" id="type_screen" value=""><img src="${path}/resources/images/wechat/type_screen.png" height="24px"></a><a href="javascript:void(0);"><img src="${path}/resources/images/wechat/lscx_screen.png" height="24px"></a></div>
</div>
...
<div id="details" class="weui-popup__container popup-bottom">
	...
	<div class="weui-popup__modal">
		...
		<div class="weui-cells" style="margin-top:44px">
			<div class="weui-cell">
				<div class="weui-cell__bd"><p>提现金额</p></div>
			...
			<div class="weui-cell">
				<div class="weui-cell__bd"><p>提现时间</p></div>
			...
			<div class="weui-cell">
				...
				<div class="weui-cell__ft"><span class="resultCode"></span></div>
			</div>
		</div>
...
<script src="${path}/resources/scripts/wechat/withdrawlsbill.js?rnd=${version}" type="text/javascript" charset="utf-8"></script>
</body></html>